...
const movies = [
  ...
  plot: "Paul Atreides leads nomadic tribes in a battle to control the desert planet Arrakis.",
  cast: [],
  crew: [],
  reviews: [],
  discussions: []
},
{
  ...
  duration: "1h 10min",
  rating: "7.8/10",
  poster: "https://upload.wikimedia.org/wikipedia/en/7/79/Frankenstein_poster_1931.jpg",
  genres: ["Horror", "Sci-Fi"],
  plot: "A scientist creates a living being from human parts with unintended consequences.",
  cast: [],
  crew: [],
  reviews: [],
  discussions: []
},
{
  ...
  plot: "A romance blossoms aboard the doomed RMS Titanic.",
  cast: [],
  crew: [],
  reviews: [],
  discussions: []
},
{
  ...
  genres: ["Sci-Fi", "Adventure"],
  plot: "A former Marine becomes part of the Na'vi tribe on the alien moon Pandora.",
  cast: [],
  crew: [],
  reviews: [],
  discussions: []
},
{
  ...
  duration: "3h 9min",
  rating: "8.0/10",
  poster: "https://upload.wikimedia.org/wikipedia/en/8/8c/Dilwale_Dulhania_Le_Jayenge_poster.jpg",
  genres: ["Romance", "Drama"],
  plot: "A young couple struggles with family traditions in their journey of love.",
  cast: [],
  crew: [],
  reviews: [],
  discussions: []
},
{
  ...
  duration: "2h 30min",
  rating: "7.6/10",
  poster: "https://upload.wikimedia.org/wikipedia/en/c/c9/Ludo_film_poster.jpg",
  genres: ["Comedy", "Crime", "Drama"],
  plot: "The lives of several characters intersect in chaotic and comedic ways.",
  cast: [],
  crew: [],
  reviews: [],
  discussions: []
},
{
  ...
  genres: ["Action", "Crime"],
  plot: "Batman faces the Joker, a criminal mastermind bringing chaos to Gotham.",
  cast: [],
  crew: [],
  reviews: [],
  discussions: []
},
{
  ...
  plot: "An insomniac office worker crosses paths with a soap salesman and forms an underground club.",
  cast: [],
  crew: [],
  reviews: [],
  discussions: []
...
},
{
  ...
  duration: "2h 21min",
  rating: "7.8/10",
  poster: "https://upload.wikimedia.org/wikipedia/en/6/6f/I_Saw_the_Devil_film_poster.jpg",
  genres: ["Thriller", "Horror"],
  plot: "A secret agent turns into a monster while hunting a serial killer.",
  cast: [],
  crew: [],
  reviews: [],
  discussions: []
},
{
  ...
  plot: "A man imprisoned for 15 years seeks revenge after being suddenly released.",
  cast: [],
  crew: [],
  reviews: [],
  discussions: []
},
{
  ...
  plot: "Alien robots battle for control of Earth.",
  cast: [],
  crew: [],
  reviews: [],
  discussions: []
},
{
  ...
  genres: ["Action", "Sci-Fi"],
  plot: "An alien child grows up on Earth and becomes its protector.",
  cast: [],
  crew: [],
  reviews: [],
  discussions: []
},
{
  ...
  genres: ["Action", "Sci-Fi"],
  plot: "The Avengers face their most powerful enemy, Thanos.",
  cast: [],
  crew: [],
  reviews: [],
  discussions: []
},
{
  ...
  plot: "A surgeon becomes a master of the mystic arts after an accident.",
  cast: [],
  crew: [],
  reviews: [],
  discussions: []
},
{
  ...
  plot: "A young hobbit begins a quest to destroy a powerful ring.",
  cast: [],
  crew: [],
  reviews: [],
  discussions: []
},
{
  ...
  duration: "2h 32min",
  rating: "7.6/10",
  poster: "https://upload.wikimedia.org/wikipedia/en/6/6e/Harry_Potter_and_the_Philosopher%27s_Stone_banner.jpg",
  genres: ["Fantasy", "Adventure"],
  plot: "A young wizard learns of his magical destiny.",
  cast: [],
  crew: [],
  reviews: [],
  discussions: []
},
{
  ...
  duration: "1h 43min",
  rating: "7.6/10",
  poster: "https://upload.wikimedia.org/wikipedia/en/5/56/Saw_official_poster.jpg",
  genres: ["Horror", "Thriller"],
  plot: "Two men wake up kidnapped in a deadly trap set by a sadistic killer.",
  cast: [],
  crew: [],
  reviews: [],
  discussions: []
},
{
  ...
  genres: ["Crime", "Thriller"],
  plot: "A hunter becomes the target of a relentless hitman after stumbling upon drug money.",
  cast: [],
  crew: [],
  reviews: [],
  discussions: []
